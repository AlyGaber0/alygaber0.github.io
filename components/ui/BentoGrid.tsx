...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("aly.gaber@mail.mcgill.ca");
    setCopied(true);
  };
  return (
    <div
            ...
            <div className="absolute right-2 flex w-fit gap-1 lg:gap-5">
              <div className="flex flex-col gap-2 lg:gap-4">
                {["React.js", "Next.js", "TypeScript"].map((item) => (
                  <span
                    key={item}
                    className="rounded-md bg-[#10132e] px-2 py-1 text-center text-[10px] opacity-70 md:text-xs lg:px-3 lg:py-2 lg:text-sm"
                  >
                    {item}
                  </span>
                ))}
